    ...
    return queryInterface.bulkInsert(
			...
			[
				...
				},
				{
					...
					website:
						'https://kerrcountytx.gov/kerr-county-all-departments/kerr-county-animal-services',
					description:
						'Kerr County Animal Services is the official animal control for Kerr County. We provide adoption and rescue programs for animals in need of good homes, serve as the local rabies control authority, and assist with wildlife situations. We work closely with local rescue organizations to save as many animals as possible.',
					userId: 4,
				},
				{
